...
public class CacheConfiguration {
  ...
  public JCacheManagerCustomizer cacheManagerCustomizer() {
    return cm -> {
      createCache(cm, com.boa.web.repository.UserRepository.USERS_BY_LOGIN_CACHE);
      createCache(cm, com.boa.web.repository.UserRepository.USERS_BY_EMAIL_CACHE);
      createCache(cm, com.boa.web.domain.User.class.getName());
      createCache(cm, com.boa.web.domain.Authority.class.getName());
      ...
      createCache(cm, com.boa.web.domain.Institution.class.getName());
